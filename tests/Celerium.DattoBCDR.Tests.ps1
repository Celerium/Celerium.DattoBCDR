...
.NOTES
    ...
    NAME: Celerium.DattoBCDR.Tests.ps1
    Type: PowerShell
...
.SYNOPSIS
    Pester tests for the Celerium.DattoBCDR module manifest file
...
.LINK
    ...
    https://github.com/Celerium/Celerium.DattoBCDR
...
Describe "Testing the [ $buildTarget ] version of [ $moduleName ] with [ $pester_TestName ]" {
    ...
    Context "[ $moduleName.psd1 ] general manifest data" {
        ...
        It "Manifest [ RootModule ] has valid data" {
            $Module.RootModule | Should -Be 'Celerium.DattoBCDR.psm1'
        }
        ...
        It "Manifest [ GUID ] has valid data" {
            $Module.GUID | Should -Be 'c128e2d8-4d4c-48cc-8a9b-12457e57d1dd'
        }
        ...
        It "Manifest [ Copyright ] has valid data" {
            $Module.Copyright | Should -Be 'https://github.com/Celerium/Celerium.DattoBCDR/blob/main/LICENSE'
        }
        ...
        It "Manifest [ LicenseUri ] has valid data" {
            $Module.LicenseUri | Should -Be 'https://github.com/Celerium/Celerium.DattoBCDR/blob/main/LICENSE'
        }

        It "Manifest [ ProjectUri ] has valid data" {
            $Module.ProjectUri  | Should -Be 'https://github.com/Celerium/Celerium.DattoBCDR'
        }

        It "Manifest [ IconUri ] has valid data" {
            $Module.IconUri  | Should -Be 'https://raw.githubusercontent.com/Celerium/Celerium.DattoBCDR/main/.github/images/Celerium_PoSHGallery_Celerium.DattoBCDR.png'
        }

        It "Manifest [ ReleaseNotes ] has valid data" {
            $Module.ReleaseNotes  | Should -Be 'https://github.com/Celerium/Celerium.DattoBCDR/blob/main/README.md'
        }
