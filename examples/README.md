...
:warning: Please note that the following examples are provided **"AS IS"** and only serve as a proof of concept to show possible uses of the [Celerium.DattoBCDR](https://github.com/Celerium/Celerium.DattoBCDR) PowerShell wrapper
...
![Agent Reports](https://raw.githubusercontent.com/Celerium/Celerium.DattoBCDR/main/.github/images/Celerium_DattoAgentsReport.png)

## Device Reports

![Device Reports](https://raw.githubusercontent.com/Celerium/Celerium.DattoBCDR/main/.github/images/Celerium_DattoDevicesReport.png)
